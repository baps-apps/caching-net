...
public sealed class RedisOptions
{
    ...
    /// <c>"redis-0.cache.svc:6379,ssl=true,abortConnect=false"</c>. Required for
    /// <see cref="CacheMode.Redis"/> and <see cref="CacheMode.Hybrid"/>. Never logged or traced
    /// verbatim — credentials are redacted before any diagnostic output.
    /// </summary>
