...
/// <see cref="IFusionCache"/> for the default cache, or apply
...
/// {
///     private readonly IFusionCache _hot = caches.GetCache("short-lived");
///     private readonly IFusionCache _main = caches.Default;
/// }
/// ]]></code>
/// </example>
