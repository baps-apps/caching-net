...
/// <summary>
/// Caching.NET additions to the cache API. Each method here does something <see cref="ICacheService"/>
/// does not already do — batching, existence probing, forced refresh. Nothing in this class renames
/// or re-exposes an existing cache method.
/// </summary>
